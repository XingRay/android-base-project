...
import com.nanosecond.makeup.android.camera.camera1.Camera1
import com.nanosecond.makeup.android.camera.camera2.Camera2
import com.nanosecond.makeup.android.camera.camerax.CameraX
import com.nanosecond.makeup.android.getCameraManager
...
fun List<Size>.selectSize(
    expectWidth: Int, expectHeight: Int, cameraPreviewSizeSelectStrategy: CameraPreviewSizeSelectStrategy
): Size {
    // 根据当前期望的宽高判定

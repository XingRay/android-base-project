...
package com.github.xingray.androidbase.camera.camera1
...
import com.nanosecond.makeup.android.camera.CameraLifecycle
import com.nanosecond.makeup.android.camera.CameraPreviewCallback
import com.nanosecond.makeup.android.camera.CameraPreviewSizeSelectStrategy
import com.nanosecond.makeup.android.camera.Format
import com.nanosecond.makeup.android.camera.LensFacing
import com.nanosecond.makeup.android.camera.Photo
import com.nanosecond.makeup.android.camera.PhotoFormat
import com.nanosecond.makeup.android.camera.contentToString
import com.nanosecond.makeup.android.camera.contentToStringWithBuilder
import com.nanosecond.makeup.android.camera.selectSize
import com.nanosecond.makeup.android.camera.sortDescend
import com.nanosecond.makeup.android.camera.toImageFormat
...
class Camera1(private val mCameraId: Int, private val mLensFacing: LensFacing, private val mCameraApi: CameraApi) : Camera {
    ...
    private fun doOpen() {
        ...
        val previewSize = sizes.selectSize(mPreviewWidth, mPreviewHeight, CameraPreviewSizeSelectStrategy.Larger)
        Log.i(TAG, "open: previewSize:${previewSize}")
        mCameraPreviewWidth = previewSize.width
        mCameraPreviewHeight = previewSize.height

        val pictureSize = sizes.selectSize(mPreviewWidth, mPreviewHeight, CameraPreviewSizeSelectStrategy.Max)
...
//        Log.d(TAG, "mCameraPreviewCallback: $data, camera:$camera")
        ...
        val cameraImage =
            CameraImage(Format.NV21, mCameraPreviewWidth, mCameraPreviewHeight, data, mCameraInfo.orientation, mLensFacing == LensFacing.FRONT)
